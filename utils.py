...
def get_dataset(args):
    ...
    data_train = data_loader(root=args.data_dir, split='train', dataset_name=args.dataset_name, resolution=args.sparse_resolution, intensity_channel=args.use_intensity,ignore_labels=args.ignore_labels)
    data_test = data_loader(root=args.data_dir, split='validation', dataset_name=args.dataset_name, resolution=args.sparse_resolution, intensity_channel=args.use_intensity,ignore_labels=args.ignore_labels)
